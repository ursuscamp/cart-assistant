<template>
  <div class="min-h-screen bg-bark-950 flex">
    <!-- Mobile Header -->
    <header
      class="fixed top-0 left-0 right-0 z-40 bg-bark-950/95 backdrop-blur-md border-b border-bark-800 lg:hidden"
    >
      <div class="flex items-center justify-between px-4 py-3">
        <button
          @click="sidebarOpen = !sidebarOpen"
          class="p-2 rounded-lg text-bark-400 hover:text-white hover:bg-bark-800"
        >
    ...
    >
      <!-- Logo -->
      <div
        class="px-4 py-4 bg-gradient-to-br from-forest-800 to-forest-950 border-b border-bark-800"
      >
        <div class="flex items-center gap-3">
          <img
            src="/source-logo.png"
            alt="Cart Assistant"
            class="w-10 h-10 rounded-lg bg-forest-600 p-1"
          />
          <div>
    ...
    <div class="flex-1 flex flex-col min-h-screen lg:ml-64">
      <!-- Desktop Header -->
      <header
        class="sticky top-0 z-30 bg-bark-950/80 backdrop-blur-md border-b border-bark-800 hidden lg:block"
      >
