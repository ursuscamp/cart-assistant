      ...
      <div class="card">
        ...
        <div class="card-body space-y-4">
          ...
          <div
            ...
            class="space-y-2 max-h-64 lg:max-h-80 overflow-y-auto scrollbar-thin"
          >
            <label
      ...
      <div class="space-y-4 lg:space-y-6">
        <div class="card">
          ...
          <div class="card-body">
            <div v-if="groceryStore.lists.length > 0" class="space-y-2">
              ...
              >
                <div
                  class="w-10 h-10 rounded-lg bg-forest-600/20 flex items-center justify-center flex-shrink-0"
                >
                  <svg
                ...
                <div class="flex-1 min-w-0">
                  <p class="font-medium text-white group-hover:text-forest-400 transition-colors">
                    {{ list.name }}
                  </p>
                ...
                <svg
                  class="w-5 h-5 text-bark-500 group-hover:text-forest-400 transition-colors flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <div v-else class="text-center py-8">
              ...
              <NuxtLink
                to="/"
                class="text-forest-400 hover:text-forest-300 text-sm mt-2 inline-block"
                >Create your first list</NuxtLink
              >
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body grid grid-cols-2 gap-3">
            <NuxtLink
              to="/lists"
              class="p-4 rounded-lg bg-bark-800/50 border border-bark-700 hover:bg-bark-800 hover:border-forest-500/50 transition-all text-center touch-manipulation"
            >
              <svg
                class="w-8 h-8 text-forest-400 mx-auto mb-2"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
...
onMounted(async () => {
  await Promise.all([listsStore.fetchLists(), groceryStore.fetchLists()]);
});
